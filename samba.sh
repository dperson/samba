...
share() { local share="$1" path="$2" browsable=${3:-yes} ro=${4:-yes} \
    ...
    echo "   veto files = /._*/Thumbs.db/ehthumbs.db/desktop.ini/.DS_Store/._.DS_Store/.AppleDouble/.apdisk/.TemporaryItems/.Trashes/Network Trash Folder/Temporary Items/" >>$file
